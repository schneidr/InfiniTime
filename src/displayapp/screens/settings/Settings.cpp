...
std::unique_ptr<Screen> Settings::CreateScreen1() {
  ...
  return std::unique_ptr<Screen>(new Screens::List(0, 3, app, settingsController, applications));
}
...
std::unique_ptr<Screen> Settings::CreateScreen2() {
  ...
  return std::unique_ptr<Screen>(new Screens::List(1, 3, app, settingsController, applications));
}
...
std::unique_ptr<Screen> Settings::CreateScreen3() {
  ...
  return std::unique_ptr<Screen>(new Screens::List(2, 3, app, settingsController, applications));
}
